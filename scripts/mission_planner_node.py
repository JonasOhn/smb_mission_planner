...
if __name__ == '__main__':
    ...
    parser.add_argument('timeout', type=float, help='Timeout for the mission (seconds).')
    ...
    mission_planner = MissionPlanner(args.mission_file_path, args.reference_frame, timeout=args.timeout)
